...
const Alert = ({ showing, success, amount }: { showing?: boolean, success: boolean, amount?: number }) => {
                ...
                <div>
                    {success && (
                        <div className="flex p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
                            ...
                            <div>
                                <span className="font-medium">Success!</span> You successfully donated {amount} ETH!
                            </div>
                        </div>
                    )}
                    {!success && (
                        <div className="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                            ...
                            <span className="sr-only">Info</span>
                            <div>
                                <span className="font-medium">Fail</span> Donation failed! Please try again.
                            </div>
                        </div>
                    )}
                </div>
